...
import EpisodeItem from '../../components/episodesComponent/episodesComponent';
...
const MovieDetails =() =>
{
  ...
  const [currentSeason,setCurrentseason]=React.useState(firstSeason);
  const [seasons, setSeasons] = React.useState(movie.seasons.items);

  const [currentEpisode,setCurrentEpisode]=React.useState(firstEpisode);
